...
export default function getTheme({ style, name }) {
  ...
  const ft = (key: keyof typeof Fthemes, op = '') => pick({ light: Fthemes[key][1] + op, dark: Fthemes[key][0] + op })
  ...
  const theme = {
    ...
    colors: {
      ...
      'editor.findMatchBackground': pick({ light: '#e6cc7744', dark: '#fff' }),
      'editor.findMatchHighlightBackground': pick({ light: '#e6cc7766', dark: '#999' }),
      ...
      'terminal.ansiBlack': pick({ light: Fthemes.background[0], dark: Fthemes.foreground[1] }),
      ...
      'terminal.ansiWhite': pick({ light: Fthemes.foreground[0], dark: Fthemes.foreground[0] }),
